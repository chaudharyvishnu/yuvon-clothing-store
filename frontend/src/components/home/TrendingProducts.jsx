    ...
    const loadTrendingProducts =
      async () => {
        try {
          ...
          setError(
            fetchError.message ||
              "Trending products load nahi ho paaye."
          );
            ...
            (product) => {
              ...
              return (
                <article
                  ...
                  className="group cursor-pointer overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 transition hover:-translate-y-1 hover:shadow-xl"
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="mt-1 min-h-14 line-clamp-2 text-lg font-bold leading-snug transition group-hover:text-rose-600">
                      {
                        product.name
                      }
                    </h3>
                    ...
                    <button
                      ...
                      className="mt-5 w-full rounded-full bg-black py-3 font-semibold text-white transition hover:bg-rose-600"
                    >
                      View Product
                    </button>
                  </div>
