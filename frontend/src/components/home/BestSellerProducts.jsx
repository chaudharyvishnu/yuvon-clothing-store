    ...
    const loadBestSellerProducts =
      async () => {
        try {
          ...
          setError(
            fetchError.message ||
              "Best seller products load nahi ho paaye."
          );
            ...
            (product) => {
              ...
              return (
                <article
                  ...
                  className="group cursor-pointer overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
                >
                  <div className="relative overflow-hidden bg-gray-100">
                    ...
                    <span className="absolute bottom-4 left-4 rounded-full bg-amber-500 px-3 py-1 text-xs font-bold text-white">
                      BEST SELLER
                    </span>
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="mt-1 min-h-14 line-clamp-2 text-lg font-bold leading-snug transition group-hover:text-amber-600">
                      {product.name}
                    </h3>
                    ...
                    <button
                      ...
                      className="mt-5 w-full rounded-full bg-black py-3 font-semibold text-white transition hover:bg-amber-500"
                    >
                      View Product
                    </button>
                  </div>
