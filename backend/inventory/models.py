...
class InventoryTransaction(models.Model):
    TRANSACTION_TYPE_CHOICES = (
        ...
        # Exchange
        ("exchange_return", "Exchange Return / Stock Restore"),
        ("exchange_out", "Exchange Replacement / Stock Out"),
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                ...
                name=(
                    "inventory_quantity_change_nonzero"
                ),
            ),
        ]
    ...
    def clean(self):
        ...
        if (
            ...
            and not inventory_settings
            .allow_negative_stock
        ):
            errors[
                "quantity_change"
            ] = (
                "This transaction would make "
                "stock negative."
            )
